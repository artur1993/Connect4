...
public class GameBoardTest {
    ...
    public void checkHorizontalTest(){
        ...
        gameBoard.printGrid();
        Assert.assertTrue(gameBoard.checkHorizontal(playerOne, gameBoard.getBoard()));
    ...
    public void checkHorizontalFiledTest(){
        ...
        gameBoard.setBoard(board);
        gameBoard.printGrid();
        Assert.assertFalse(gameBoard.checkHorizontal(playerOne, gameBoard.getBoard()));
    ...
    public void checkVerticalTest(){
        ...
        gameBoard.move(2,playerOne);
        gameBoard.printGrid();
        Assert.assertTrue(gameBoard.checkVertical(1, gameBoard.getBoard()));
    }
    @Test
    public void checkVerticalFiledTest(){
        ...
        gameBoard.move(2,playerOne);
        gameBoard.printGrid();
        Assert.assertFalse(gameBoard.checkVertical(1, gameBoard.getBoard()));
    }
    ...
    public void checkDiagonal00To67Test(){
        ...
        gameBoard.move(3,playerOne);
        gameBoard.printGrid();
        Assert.assertTrue(gameBoard.checkDiagonal00To67(1, gameBoard.getBoard()));
    }
    ...
    public void checkDiagonal00To67FiledTest(){
        ...
        gameBoard.move(4,playerOne);
        gameBoard.printGrid();
        Assert.assertFalse(gameBoard.checkDiagonal00To67(1, gameBoard.getBoard()));
    }
    ...
    public void checkDiagonal60To07Test(){
        ...
        gameBoard.move(3,playerOne);
        gameBoard.printGrid();
        Assert.assertTrue(gameBoard.checkDiagonal60To07(1, gameBoard.getBoard()));
    }
    ...
    public void checkDiagonal60To07FiledTest(){
        ...
        gameBoard.move(2,playerOne);
        gameBoard.printGrid();
        Assert.assertFalse(gameBoard.checkDiagonal60To07(1, gameBoard.getBoard()));
    }
